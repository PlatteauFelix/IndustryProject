        ...
        for i, det in enumerate(pred):  # per image
            ...
            if poly == "":
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if Goal(xCoord,yCoord,save_dir,(math.trunc(time)),poly):
                        text_Goal = cv2.putText(im0,f"Goal",(450,150),cv2.FONT_HERSHEY_PLAIN,10,(0, 50, 255),10)
...
def parse_opt():
    ...
    parser.add_argument('--project', default=ROOT / 'runs/detectCoords', help='save results to project/name')
